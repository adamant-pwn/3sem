...
/*
 * Продемонстрируете на семинаре работу для двух случаев:
 * 1) Мойщик много быстрее вытиральщика. Стол забивается.
 * 2) Вытиральщик много быстрее мойщика -> стол не забивается даже при размере 1.
 * 
 * P.S. глобальные переменные нужно использовать только в случае крайней необходимости.
 */
